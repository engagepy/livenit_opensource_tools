...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Superhero.name'
        db.add_column(u'superhero_superhero', 'name',
                      self.gf('django.db.models.fields.CharField')(default='legacy', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Superhero.name'
        db.delete_column(u'superhero_superhero', 'name')
    ...
    models = {
        ...
        u'superhero.superhero': {
            'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'Superhero', '_ormbases': [u'jmbo.ModelBase']},
